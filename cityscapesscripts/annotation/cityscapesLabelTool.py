...
# This tmp is loaded when started and saved when leaving
class configuration:
    # Constructor
    def __init__(self):
    ...
    # Make sure the tmp is consistent.
...
class CityscapesLabelTool(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        # The filename of where the tmp is saved and loaded
        ...
        # If we already know a city from the saved tmp -> load it
        self.loadCity()
        self.imageChanged()
    ...
    #   - self.tmp.city           : path to the folder containing the images to annotate
    #   - self.tmp.cityName       : name of this folder, i.e. the city
    #   - self.tmp.labelPath      : path to the folder to store the polygons
    #   - self.tmp.correctionPath : path to store the correction boxes in
    #   - self.tmp.gtType         : type of ground truth, e.g. gtFine or gtCoarse
    #   - self.tmp.split          : type of split, e.g. train, val, test
